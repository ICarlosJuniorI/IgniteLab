          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/ICarlosJuniorI.png"
                alt=""
              />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Carlos Junior</strong>
                <span className="text-gray-200 text-sm block">DEV | ZEMA</span>
              </div>
            </div>
          </div>
